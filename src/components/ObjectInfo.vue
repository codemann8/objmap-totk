<template>
  <div :class="className + (isStatic ? ' static' : '')">
    ...
    <section class="search-result-location">
      <span v-if="resolvedMapName().startsWith('Sky')"> <i class="fa fa-cloud fa-fw" style="color: lightblue"></i></span>
      <span v-else-if="resolvedMapName().startsWith('Cave')"> <i class="fas fa-archway fa-fw" style="color: rosybrown"></i></span>
      <span v-else-if="resolvedMapName().startsWith('LargeDungeon__LargeDungeonWind')"> <i class="fas fa-cloud fa-fw" style="color: lightblue"></i></span>
      <span v-else-if="resolvedMapName().startsWith('LargeDungeon__LargeDungeonWater')"> <i class="fas fa-cloud fa-fw" style="color: lightblue"></i></span>
